# nf-core/metabolinden: Usage

## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/metabolinden/usage](https://nf-co.re/metabolinden/usage)
...
```bash
nextflow pull nf-core/metabolinden
```
...
First, go to the [nf-core/metabolinden releases page](https://github.com/nf-core/metabolinden/releases) and find the latest version number - numeric only (eg. `1.3.1`). Then specify this when running the pipeline with `-r` (one hyphen) - eg. `-r 1.3.1`.
...
* `docker`
  ...
  * Pulls software from Docker Hub: [`nfcore/metabolinden`](https://hub.docker.com/r/nfcore/metabolinden/)
* `singularity`
