...
<!--
# nf-core/metabolinden bug report
...
- [ ] [nf-core/metabolinden pipeline documentation](https://nf-co.re/nf-core/metabolinden/usage)
...
- version: <!-- [e.g. 1.0.0] -->
- Image tag: <!-- [e.g. nfcore/metabolinden:1.0.0] -->
